...
<%@ page contentType="text/html;charset=UTF-8" language="java" %>
    ...
    <link href="../files/pc/styles.css" type="text/css" rel="stylesheet"/>
...
<body>
      ...
      <!-- 楼层列表 (动态面板) -->
      <div id="u286" class="ax_default" data-label="楼层列表">
        <div id="u286_state0" class="panel_state" data-label="默认">
          <div id="u286_state0_content" class="panel_state_content">
            ...
            <!-- 幢/层 (动态面板) -->
            <div id="u291" class="ax_default" data-label="幢/层">
              <div id="u291_state0" class="panel_state" data-label="全部">
                <div id="u291_state0_content" class="panel_state_content">
                  ...
                  <div id="u373" class="ax_default label">
                    ...
                    <div id="u374" class="text" style="visibility: visible;">
                      <p><span>上传于2017.5.7 14:00</span></p>
                    </div>
                  </div>
              ...
              <div id="u291_state1" class="panel_state" data-label="1幢全部楼层" style="display: none; visibility: hidden;">
        ...
        <div id="u286_state1" class="panel_state" data-label="筛选后" style="display: none; visibility: hidden;">
            ...
            <div id="u486" class="ax_default">
              ...
              <div id="u489" class="ax_default label">
                ...
                <div id="u490" class="text" style="visibility: visible;">
                  <p><span>1幢11层全景图</span></p>
                </div>
              </div>
            </div>
          </div>
        </div>
        <div id="u286_state2" class="panel_state" data-label="某幢全部楼层" style="display: none; visibility: hidden;">
          <div id="u286_state2_content" class="panel_state_content">
      ...
      <!-- 项目图 (动态面板) -->
      <div id="u531" class="ax_default" data-label="项目图">
        <div id="u531_state0" class="panel_state" data-label="楼层图">
          <div id="u531_state0_content" class="panel_state_content">

            <!-- 项目3D图 (动态面板) -->
            <div id="u532" class="ax_default" data-label="项目3D图">
              <div id="u532_state0" class="panel_state" data-label="俯视图">
              ...
              <div id="u532_state1" class="panel_state" data-label="幢图" style="display: none; visibility: hidden;">
                <div id="u532_state1_content" class="panel_state_content">
                </div>
              </div>
            </div>
          </div>
      ...
      <!-- 项目3D图 (动态面板) -->
      <div id="u543" class="ax_default" data-label="项目3D图">
        <div id="u543_state0" class="panel_state" data-label="俯视图">
        ...
        <div id="u543_state1" class="panel_state" data-label="楼层图" style="display: none; visibility: hidden;">
          <div id="u543_state1_content" class="panel_state_content">
            ...
            <!-- 1层 (热区) -->
            <div id="u560" class="ax_default" data-label="1层">
            </div>

            <!-- -1层 (热区) -->
            <div id="u561" class="ax_default" data-label="-1层">
            </div>

            <!-- 2层 (热区) -->
            <div id="u562" class="ax_default" data-label="2层">
            </div>

            <!-- 3层 (热区) -->
            <div id="u563" class="ax_default" data-label="3层">
            </div>

            <!-- 4层 (热区) -->
            <div id="u564" class="ax_default" data-label="4层">
            </div>

            <!-- 5层 (热区) -->
            <div id="u565" class="ax_default" data-label="5层">
            </div>

            <!-- 6层 (热区) -->
            <div id="u566" class="ax_default" data-label="6层">
            </div>

            <!-- 7层 (热区) -->
            <div id="u567" class="ax_default" data-label="7层">
            </div>

            <!-- 8层 (热区) -->
            <div id="u568" class="ax_default" data-label="8层">
            </div>

            <!-- 9层 (热区) -->
            <div id="u569" class="ax_default" data-label="9层">
            </div>

            <!-- 10层 (热区) -->
            <div id="u570" class="ax_default" data-label="10层">
            </div>
          </div>
        </div>
      </div>
      <form action="sreachIndexInfo.do" id="sreachForm" method="post">
      <!-- Unnamed (下拉列表框) -->
      <div id="u571" class="ax_default droplist">
        <select id="u571_input" name="dName">
          <option value="" selected="selected">-- 选择幢 --</option>
          <option value="1">1幢</option>
          <option value="2">2幢</option>
          <option value="3">3幢</option>
          <option value="4">4幢</option>
        </select>
      </div>

      <!-- Unnamed (下拉列表框) -->
      <div id="u572" class="ax_default droplist">
        <select id="u572_input" name="lcNum">
          <option value="" selected="selected">-- 选择楼层 --</option>
      ...
      <div id="u573" class="ax_default">
        <input id="date_start" style="width: 90px;"  placeholder="开始时间"   name="startTime"/>
      </div>

      <!-- Unnamed (矩形) -->
      <div id="u575" class="ax_default">
        <input id="date_end" style="width: 90px;"  placeholder="结束时间"  name="endTime"/>
      </div>
      ...
      <div id="u579" class="ax_default box_1">
        ...
        <div id="u580" class="text" style="visibility: visible;">
          <p><span style="cursor: pointer;" id="sreachBtn">筛选</span></p>
        </div>
      </div>
      ...
      <div id="u581" class="ax_default">
        ...
        <!-- Unnamed (文本框) -->
        <div id="u584" class="ax_default text_field">
          <input id="u584_input" type="text" value=""  placeholder="采集人名称"  name="cjUserName"/>
        </div>
      </div>
      ...
      <div id="u585" class="ax_default box_1">
        ...
        <div id="u586" class="text" style="visibility: visible;">
          <p><span style="cursor: pointer;" id="clearFormBtn">清空</span></p>
        </div>
      </div>
      </form>
    </div>
